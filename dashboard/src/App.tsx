...
export default function App() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const host = baseUrl.includes('localhost:5173') ? 'http://localhost:3000' : baseUrl;
        ...
        <div className="max-w-7xl mx-auto px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-sm tracking-tight">memox portal</span>
            </div>
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-[#09090b] border border-[#27272a] rounded-lg p-6">
                      ...
                      <div className="text-2xl font-bold font-mono">{stats.totalWrites}</div>
                    ...
                    <div className="bg-[#09090b] border border-[#27272a] rounded-lg p-6">
                      ...
                      <div className="text-2xl font-bold font-mono">{stats.totalLoads}</div>
                    ...
                    <div className="bg-[#09090b] border border-[#27272a] rounded-lg p-6">
                      <div className="flex items-center justify-between space-y-0 pb-2">
                        ...
                        <Brain className="h-4 w-4 text-[#a1a1aa]" />
                      </div>
                    ...
                    <div className="bg-[#09090b] border border-[#27272a] rounded-lg p-6">
                      ...
                      <div className="text-2xl font-bold font-mono text-amber-500">{stats.tokenCount}</div>
                    ...
                    <div className="bg-[#09090b] border border-[#27272a] rounded-lg p-6 flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-emerald-400 font-mono">{stats.successRate}%</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="h-64">
                          <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={chartData}>
                              ...
                              <Bar dataKey="Requests" fill="#fafafa" radius={[4, 4, 0, 0]} />
                            </BarChart>
                          </ResponsiveContainer>
                        </div>
                      )}
                        ...
                        <div className="h-64">
                          <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={latencyHistory}>
                              ...
                              <Tooltip contentStyle={{ backgroundColor: '#09090b', borderColor: '#27272a', color: '#fafafa' }} />
                              <Area type="monotone" dataKey="Latency" stroke="#71717a" fillOpacity={0.1} fill="#ffffff" />
                            </AreaChart>
                          </ResponsiveContainer>
                        </div>
                      )}
...
{`curl -X POST http://localhost:3000/v1/memory/write \\
  ...
  -d '{
    ...
    "metadata": { "topic": "preferences" }
                              ...
                              <button 
                                onClick={() => triggerCopy(`curl -X POST http://localhost:3000/v1/memory/write \\\n  -H "Content-Type: application/json" \\\n  -d '{\n    "sessionId": "agent-session-123",\n    "content": "User prefer dark theme interfaces",\n    "metadata": { "topic": "preferences" }\n  }'`, 'api-write')}
                                className="absolute right-3 top-3 p-1.5 rounded hover:bg-[#27272a] text-[#a1a1aa] hover:text-white transition-colors"
                              >
                          ...
                          <div>
                            ...
                            <div className="relative mt-2">
                              <pre className="bg-[#18181b] text-zinc-300 font-mono text-[10px] p-4 rounded border border-[#27272a] overflow-x-auto">
{`curl -X POST http://localhost:3000/v1/memory/load \\
  -H "Content-Type: application/json" \\
  -d '{
    "sessionId": "agent-session-123",
    "query": "what theme does user like?"
                              ...
                              <button 
                                onClick={() => triggerCopy(`curl -X POST http://localhost:3000/v1/memory/load \\\n  -H "Content-Type: application/json" \\\n  -d '{\n    "sessionId": "agent-session-123",\n    "query": "what theme does user like?"\n  }'`, 'api-load')}
                                className="absolute right-3 top-3 p-1.5 rounded hover:bg-[#27272a] text-[#a1a1aa] hover:text-white transition-colors"
                              >
...
client = MemoxClient(base_url="http://localhost:3000")
...
const memox = new MemoxClient("http://localhost:3000");
...
const graph = new StateGraph()
  ...
  .addEdge("agent", "memox_saver");`}
      ...
      {/* Footer */}
      <footer className="border-t border-[#27272a] py-6 flex flex-col items-center justify-center gap-2 text-[10px] text-[#71717a] mt-auto">
        <Logo className="h-5 w-5 text-[#27272a]" />
